...
-- ALTER TABLE USER ADD CONSTRAINT USER_MAJOR_FK FOREIGN KEY(majorID) REFERENCES MAJOR(majorID);
-- ALTER TABLE PROJECT ADD CONSTRAINT PROJECT_USER_FK FOREIGN KEY(projectOwner) REFERENCES USER(userID);
-- ALTER TABLE PROJECT ADD CONSTRAINT PROJECT_MAJOR_FK FOREIGN KEY(majorID) REFERENCES MAJOR(majorID);
-- ALTER TABLE PARTICIPATE ADD CONSTRAINT PARTICIPATE_USER_FK FOREIGN KEY(userID) REFERENCES USER(userID);
-- ALTER TABLE PROGRESS ADD CONSTRAINT PROGRESS_USER_FK FOREIGN KEY(userID) REFERENCES USER(userID);
-- ALTER TABLE STARREDPROJECT ADD CONSTRAINT STARREDPROJECT_USER_FK FOREIGN KEY(userID) REFERENCES USER(userID);
